Feature: Home
 ...
 Scenario: [POSITIVE] [AUT-1] As a user i want to see necessary information regarding ecoshop 
    Given I open ecoshop homepage
 ...
 Scenario: [POSITIVE] [AUT-2] As a user i want to interact with FAQ dropdowns 
    Given I open ecoshop homepage
